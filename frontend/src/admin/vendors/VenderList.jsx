...
import style from "./VenderList.module.css"
...
const VenderList = () => {
  ...
  return (
    ...
    <div style={{display:"grid"}}>
        <Heading mr="300px" mt="40px" >Vender List</Heading>
        <a herf="/"><Heading  mr="300px" mt="40px" size={"md"} >  Home   <span> Vender </span> </Heading></a>
        </div>
